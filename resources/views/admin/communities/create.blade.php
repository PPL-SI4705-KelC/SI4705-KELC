    ...
    <div class="max-w-2xl mx-auto animate-fade-in">
        <div class="card">
            <form method="POST" action="{{ route('admin.communities.store') }}" enctype="multipart/form-data" class="space-y-5">
                ...
                <div>
                    <label class="form-label">Cover Image <span class="text-content-muted font-normal">(recommended 1200x600px)</span></label>
                    
                    <!-- Custom Interactive Upload Zone -->
                    <div id="upload-zone" class="relative group cursor-pointer border-2 border-dashed border-gray-200 hover:border-[#2D5A4C] rounded-2xl p-6 bg-gray-50/50 hover:bg-emerald-50/10 transition-all duration-300 flex flex-col items-center justify-center text-center overflow-hidden min-h-[180px] max-w-lg">
                        ...
                        <div id="upload-prompt" class="flex flex-col items-center gap-2 transition-all duration-300">
                            <div class="w-12 h-12 rounded-2xl bg-white shadow-sm border border-gray-150 flex items-center justify-center text-gray-400 group-hover:text-[#2D5A4C] group-hover:scale-110 transition-all duration-300">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 16.5V9.75m0 0l3 3m-3-3l-3 3M6.75 19.5a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z"/>
                                </svg>
                            </div>
                            <p class="text-xs font-bold text-gray-700 mt-1">Choose a file or drag it here</p>
                            <p class="text-[10px] text-gray-400 font-medium">PNG, JPG, JPEG, WEBP up to 2MB</p>
                        </div>
                        ...
                        <div id="image-preview-container" class="absolute inset-0 hidden z-10 w-full h-full bg-gray-50">
                            ...
                            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col items-center justify-center text-white gap-1 select-none">
                                ...
                                <span class="text-xs font-bold">Change Image</span>
                            </div>
                            <!-- Remove button -->
                            <button type="button" id="remove-preview-btn" class="absolute top-3 right-3 bg-black/50 hover:bg-red-500 text-white rounded-full p-2 transition active:scale-95 shadow-md flex items-center justify-center z-20" title="Remove image">
