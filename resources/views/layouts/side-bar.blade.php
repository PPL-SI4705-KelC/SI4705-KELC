    ...
    <div class="h-full px-6 py-8 flex flex-col items-center overflow-y-auto">
        ...
        @if(request()->routeIs('admin.*'))
            ...
            <nav class="w-full space-y-4">
                ...
                <a href="{{ route('admin.blogs') }}" class="flex justify-center items-center w-full py-3.5 px-4 rounded-full font-bold text-sm tracking-wide transition-all {{ request()->routeIs('admin.blogs*') ? 'bg-[#2D5A4C] text-white shadow-sm' : 'text-[#2D5A4C] hover:bg-gray-50' }}">
                    Blogs
                </a>
                ...
                <a href="{{ route('admin.challenges') }}" class="flex justify-center items-center w-full py-3.5 px-4 rounded-full font-bold text-sm tracking-wide transition-all {{ request()->routeIs('admin.challenges*') ? 'bg-[#2D5A4C] text-white shadow-sm' : 'text-[#2D5A4C] hover:bg-gray-50' }}">
                    Challenge
                </a>
            </nav>
